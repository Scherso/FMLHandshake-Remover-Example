...
loom {
    ...
    launchConfigs {
        getByName("client") {
            /* Ensuring that the mod is loaded as a core-mod to
             * ensure that class transformers will work. */
            arg("-Dfml.coreMods.load", "dev.salmon.handshakeremover.FMLPlugin")
        }
    }
...
tasks.named<Jar>("jar") {
    ...
    manifest.attributes.run {
        ...
        this["FMLCorePlugin"] = "dev.salmon.handshakeremover.FMLPlugin"
        this["ModType"] = "FML"
